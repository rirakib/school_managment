    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('staf.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="staf_type" class="control-label col-md-3 col-sm-3 col-xs-12">Staf Type</label>
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control @error('staf_type') is-invalid @enderror" name="staf_type">
                                        <option>Choose type</option>
                                        @foreach(DB::table('staf_types')->get() as $staf)
