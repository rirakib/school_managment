        ...
        <div class="title_left">
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><a href="{{route('staf.index')}}" class="link">Staf</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('staf.update',$staf->id)}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$staf->name}}" class="form-control @error('name') is-invalid @enderror"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$staf->father_name}}" class="form-control @error('father_name') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$staf->mother_name}}" class="form-control @error('mother_name') is-invalid @enderror"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$staf->national_id}}" class="form-control" id="national_id" name="national_id"
                                        required="required">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                        ...
                                        id="present_address" name="present_address" value="{{$staf->present_address}}" required="required">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                        ...
                                        id="parmanenet_address" value="{{$staf->parmanent_address}}" name="parmanent_address" required="required">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control @error('mobile_number') is-invalid @enderror"
                                        id="mobile_number" name="mobile_number" value="{{$staf->mobile_number}}" required="required">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="email" class="form-control" value="{{$staf->email}}" id="email" name="email">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control" name="blood_group">
                                        <option value="{{$staf->blood_group}}">{{$staf->blood_group}}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control" name="ssc">
                                        <option value="{{$staf->ssc}}">{{$staf->ssc}}</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$staf->ssc_result}}" id="ssc_result" placeholder="GPA/CGPA"
                                        name="ssc_result">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control" name="hsc">
                                        <option value="{{$staf->hsc}}">{{$staf->hsc}}</option>
                                        <option value="science">Science</option>
                                        <option value="arts">Arts</option>
                                        <option value="commerce">commerce</option>
                                        <option value="others">others</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$staf->hsc_result}}" id="hsc_result" placeholder="GPA/CGPA"
                                        name="hsc_result">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$staf->hounars_subject}}" id="hounars_subject" placeholder="Optional"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$staf->hounars_result}}" id="hounars_result" placeholder="GPA/CGPA"
                                        name="hounars_result">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$staf->masters_subject}}" id="masters_subject" placeholder="Optional"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" id="masters_result" value="{{$staf->masters_result}}" placeholder="GPA/CGPA"
                                        name="masters_result">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <p>{{$staf->resume_image}}</p>
                                    <input id="resume_image" class="form-control col-md-7 col-xs-12" type="file"
                                    value="{{$staf->resume_image}}"   name="resume_image">
                                </div>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="image" class="control-label col-md-3 col-sm-3 col-xs-12">staf Image
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <img src="{{asset('images/staf/image/'.$staf->image)}}" style="height:70px; width:70px; object-fit:cover; object-position:center;" alt="">
                                    <input id="image"
                                        class="form-control col-md-7 col-xs-12 @error('image') is-invalid @enderror"
                                        type="file" value="{{$staf->image}}" name="image" >
                                </div>
                            </div>
