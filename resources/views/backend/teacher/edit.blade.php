    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('teacher.update',$teacher->id)}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$teacher->name}}" class="form-control @error('name') is-invalid @enderror"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$teacher->father_name}}" class="form-control @error('father_name') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$teacher->mother_name}}" class="form-control @error('mother_name') is-invalid @enderror"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$teacher->national_id}}" class="form-control" id="national_id" name="national_id"
                                        required="required">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                        ...
                                        id="present_address" name="present_address" value="{{$teacher->present_address}}" required="required">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                        ...
                                        id="parmanenet_address" value="{{$teacher->parmanent_address}}" name="parmanent_address" required="required">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control @error('mobile_number') is-invalid @enderror"
                                        id="mobile_number" name="mobile_number" value="{{$teacher->mobile_number}}" required="required">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control" name="ssc">
                                        <option value="{{$teacher->ssc}}">{{$teacher->ssc}}</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$teacher->ssc_result}}" id="ssc_result" placeholder="GPA/CGPA"
                                        name="ssc_result">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-7 col-sm-9 col-xs-12">
                                    <select class="form-control" name="hsc">
                                        <option value="{{$teacher->hsc}}">{{$teacher->hsc}}</option>
                                        <option value="science">Science</option>
                                        <option value="arts">Arts</option>
                                        <option value="commerce">commerce</option>
                                        <option value="others">others</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$teacher->hsc_result}}" id="hsc_result" placeholder="GPA/CGPA"
                                        name="hsc_result">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$teacher->hounars_subject}}" id="hounars_subject" placeholder="Optional"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$teacher->hounars_result}}" id="hounars_result" placeholder="GPA/CGPA"
                                        name="hounars_result">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" value="{{$teacher->masters_subject}}" id="masters_subject" placeholder="Optional"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" id="masters_result" value="{{$teacher->masters_result}}" placeholder="GPA/CGPA"
                                        name="masters_result">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <img src="{{asset('images/teacher/image/'.$teacher->image)}}" style="height:70px; width:70px; object-fit:cover; object-position:center;" alt="">
                                    <input id="image"
                                        class="form-control col-md-7 col-xs-12 @error('image') is-invalid @enderror"
                                        type="file" value="{{$teacher->image}}" name="image" >
                                </div>
                            </div>
